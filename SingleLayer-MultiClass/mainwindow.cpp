...
MainWindow::MainWindow(QWidget *parent)
  ...
  ui->setupUi(this);
  this->setWindowTitle("SingleLayer Network Classifier");

  ui->radioButtonPerceptron->click();
...
/*---------------------------------------------------------------------------*/
void MainWindow::on_radioButtonPerceptron_clicked(){
  if(ann != nullptr) ann->setDeltaRule(false);
}

/*---------------------------------------------------------------------------*/
void MainWindow::on_radioButtonDelta_clicked(){
  if(ann != nullptr) ann->setDeltaRule(true);
}

/*---------------------------------------------------------------------------*/
void MainWindow::on_checkBoxNormalize_stateChanged(int arg1){
  if(ann != nullptr) ann->setNormalizeEnabled(arg1);
...
void MainWindow::on_pushButtonGenerateClasses_clicked(){
  ...
  if(classNumber > 1){
    ...
    ann = new Ann(classNumber, ui->radioButtonDelta->isChecked(), 
                ui->checkBoxNormalize->isChecked(), coordinateBox);
  } else{
